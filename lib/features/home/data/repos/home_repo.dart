...
abstract class HomeRepo {
  ...
  Future<Either<ServerException, List<WishlistItem>>> fetchWishlist();
  Future<Either<ServerException, List<WishlistItem>>> removeProductFromWishList(String wishlistItemId);
